...
public class BoardState {
    ...
    public BoardState(BoardPos enPas, Piece oldPiece, Piece taken, boolean canWhiteQueenCastle, boolean canWhiteKingCastle, boolean canBlackQueenCastle, boolean canBlackKingCastle) {
        this.enPas = enPas;
