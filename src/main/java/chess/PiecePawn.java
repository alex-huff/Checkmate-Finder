...
public class PiecePawn extends Piece {
    ...
    public PiecePawn(Board board, Team team) {
        super(board, team);
    }
    ...
    public List<Move> getSpecialMoves() {
        ...
        if (this.board.getEnTar() == null) return moves;
        ...
        if (diff == 1 || diff == -1) {
            if (this.getTeam().equals(Team.WHITE) && initialRow == 4 && this.board.getEnTar().getRow() == 5) {
                this.board.addMoveIfNoCheck(moves, new Move(initialRow, initialCol, 5, this.board.getEnTar().getCol(), new BoardPos(4, this.board.getEnTar().getCol())));
            } else if (this.getTeam().equals(Team.BLACK) && initialRow == 3 && this.board.getEnTar().getRow() == 2) {
                this.board.addMoveIfNoCheck(moves, new Move(initialRow, initialCol, 2, this.board.getEnTar().getCol(), new BoardPos(3, this.board.getEnTar().getCol())));
            }
        }
    ...
    public List<Move> getLegalSpan() {
        ...
        if (this.getTeam().equals(Team.WHITE)) {
            ...
            if (initialRow == 1) { //can only move two spaces forward on first move
                if (this.board.inBounds(r, c)) {
                    piece = this.board.getPieceAt(r, c);
            ...
            if (initialRow == 6) { //can only move two spaces forward on first move
                if (this.board.inBounds(r, c)) {
                    piece = this.board.getPieceAt(r, c);
    ...
    public List<BoardPos> getSpan() {
        ...
        if (this.getTeam().equals(Team.WHITE)) {
            ...
            if (this.board.inBounds(r, c)) {
                ...
                if (piece == null || piece.getTeam().equals(Team.BLACK)) moves.add(new BoardPos(r, c));
            }
            ...
            if (this.board.inBounds(r, c)) {
                ...
                if (piece == null || piece.getTeam().equals(Team.WHITE)) moves.add(new BoardPos(r, c));
            }
