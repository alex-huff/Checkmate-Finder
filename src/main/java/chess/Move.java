...
public class Move {
    ...
    public Move(int fromRow, int fromCol, int toRow, int toCol, BoardPos take) {
        this.from = new BoardPos(fromRow, fromCol);
        this.to = new BoardPos(toRow, toCol);
        this.take = take;
    }

    public Move(BoardPos start, BoardPos finish, BoardPos take) {
        this(start.getRow(), start.getCol(), finish.getRow(), finish.getCol(), take);
    }

    public Move(BoardPos start, BoardPos finish) {
